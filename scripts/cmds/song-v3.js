...
module.exports = {
  config: {
    ...
    longDescription: "Search YouTube then fetch MP3 from /cdn API",
    category: "media",
    guide: "{p}{n} <song name>",
  },
  ...
  onStart: async function ({ api, event, args }) {
    if (args.length === 0) {
      return api.sendMessage("» উফফ কি গান শুনতে চাস তার ২/১ লাইন তো লেখবি নাকি 😾", event.threadID, event.messageID);
    }
